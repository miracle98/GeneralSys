...
namespace DbTools
{
    ...
    /// 
    /// </summary>
    public static class DbModelTools
    {
        public static string ToUpper(string tableName)
        {
            return tableName.ToUpper();
        }
        public static string GetColumnDesc(string table, string columnName)
        {
            Write(table + "_" + columnName);
        ...
        public static string GetTableDesc(string tableName)
        {
            ...
            if (sgsysTableSchema != null)
                return sgsysTableSchema.TableDesc;
            return "";
        }
        ...
        {
            FileStream fs = new FileStream("D:/aa.txt", FileMode.Append);
